...
int main()
{
    ...
    for (int i = 0; i < NRUNS; i++)
    {
        ...
        std::cout << "Error compared to non-iterative solver in L1 norm for Kaczmarz: "
        ...
        std::cout << "Error compared to non-iterative solver in L1 norm for Eigen iterative: "
                  << (x_iter - x_precise).lpNorm<1>() << std::endl;
        std::cout << "Error compared to non-iterative solver in Linf norm: "
                  << (x_iter - x_precise).lpNorm<Eigen::Infinity>()
                  << std::endl;
