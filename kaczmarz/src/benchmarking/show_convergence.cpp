...
int main() {
  ...
  outFile << "Problem,Complexity,Degree,Precision,AvgCarpTime,StdDevCarpTime,"
             "AvgNormalTime,StdDevNormalTime\n";
    ...
    for (int complexity = 1; complexity <= 4; ++complexity) {
      for (int degree = 1; degree <= 1; ++degree) {
        ...
        file_path << "../../generated_bvp_matrices/problem" << problem
                  << "/problem" << problem << "_complexity" << complexity
                  << "_degree" << degree << ".txt";
        ...
        for (int precision_level = 0; precision_level < NRUNS;
             ++precision_level) {
          //////////////////////////////////////////
          ...
          //////////////////////////////////////////
          double avg_carp_time =
              std::accumulate(carp_times.begin(), carp_times.end(), 0.0) /
              NUM_REPETITIONS;
          ...
          double avg_normal_time =
              ...
              NUM_REPETITIONS;
          double stddev_normal_time =
              compute_stddev(normal_times, avg_normal_time);

          //////////////////////////////////////////
          // Write Results to CSV
          //////////////////////////////////////////
          outFile << problem << "," << complexity << "," << degree << ","
                  << precision << "," << avg_carp_time << ","
                  << stddev_carp_time << "," << avg_normal_time << ","
                  << stddev_normal_time << "\n";
        ...
        std::cout << "Finished processing file: " << file_path.str()
                  << std::endl;
      }
    }
  }
