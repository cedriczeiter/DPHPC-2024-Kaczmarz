...
/**
    ...
    *
    * This function solves a system of linear equations using the Kaczmarz method on a GPU.
    *
    * @param h_A_outer Pointer to the outer indices of the sparse matrix in CSR format.
    * @param h_A_inner Pointer to the inner indices of the sparse matrix in CSR format.
    * @param h_A_values Pointer to the non-zero values of the sparse matrix in CSR format.
    ...
    * @param max_nnz_in_row Maximum number of non-zero elements in any row of the matrix.
