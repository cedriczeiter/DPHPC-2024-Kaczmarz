...
# Create the plot with error bars and connected lines
plt.errorbar(data_banded_cpu_sparse["Dim"], data_banded_cpu_sparse["AvgTime"], yerr=data_banded_cpu_sparse["StdDev"], fmt='o-', capsize=5, label="Banded CPU Solver Sparse")
